class Admin::AllergiesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @allergy.save
        format.html { redirect_to [:admin, @allergy], notice: 'Allergy was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @allergy.update(allergy_params)
        format.html { redirect_to [:admin, @allergy], notice: 'Allergy was successfully updated.' }
  ...
  def destroy
    @allergy.destroy
    respond_to do |format|
      format.html { redirect_to admin_allergies_url, notice: 'Allergy was successfully destroyed.' }
