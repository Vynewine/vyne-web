...
ActiveRecord::Schema.define(version: 20150505092743) do
  ...
  add_index "carts", ["warehouse_id"], :name => "index_carts_on_warehouse_id"
  ...
  create_table "promotions", force: true do |t|
    ...
    t.integer  "free_bottle_category_id"
    t.boolean  "referral_promotion"
    t.text     "description"
    t.boolean  "new_accounts_only",       default: true
  end
