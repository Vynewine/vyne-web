...
class InventoriesControllerTest < ActionController::TestCase
  ...
  test "should create inventory" do
    assert_difference('Inventory.count') do
      post :create, inventory: { quantity: @inventory.quantity, warehouse: @inventory.warehouse, wine: @inventory.wine }
    end
  ...
  test "should update inventory" do
    patch :update, id: @inventory, inventory: { quantity: @inventory.quantity, warehouse: @inventory.warehouse, wine: @inventory.wine }
    assert_redirected_to inventory_path(assigns(:inventory))
  end
